# Generated by Django 5.1.1 on 2024-10-19 17:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("song_id", models.ManyToManyField(to="musicapp.playlist_song")),
                (
                    "user_id",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="musicapp.user"
                    ),
                ),
            ],
        ),
